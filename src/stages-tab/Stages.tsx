                    ...
                    <>
                        <div className="flex flex-col gap-3 bg-white rounded-lg shadow-md p-5">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mb-3">The <strong>Applied</strong>, <strong>Hired</strong> and <strong>Rejected</strong> stages are mandatory. You may choose either one or both of the other two stages.</p>
                            </div>
